...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tracksGroupBox = QtWidgets.QGroupBox(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.tracksGroupBox.sizePolicy().hasHeightForWidth())
        self.tracksGroupBox.setSizePolicy(sizePolicy)
        self.tracksGroupBox.setMaximumSize(QtCore.QSize(120, 16777215))
        self.tracksGroupBox.setObjectName("tracksGroupBox")
        self.gridLayout_2 = QtWidgets.QGridLayout(self.tracksGroupBox)
        self.gridLayout_2.setObjectName("gridLayout_2")
        self.track1HorizontalLayout = QtWidgets.QHBoxLayout()
        self.track1HorizontalLayout.setObjectName("track1HorizontalLayout")
        self.track1 = QtWidgets.QCheckBox(self.tracksGroupBox)
        self.track1.setObjectName("track1")
        self.track1HorizontalLayout.addWidget(self.track1)
        self.colorLabel1 = QtWidgets.QLabel(self.tracksGroupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.colorLabel1.sizePolicy().hasHeightForWidth())
        self.colorLabel1.setSizePolicy(sizePolicy)
        self.colorLabel1.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.colorLabel1.setObjectName("colorLabel1")
        self.track1HorizontalLayout.addWidget(self.colorLabel1)
        self.gridLayout_2.addLayout(self.track1HorizontalLayout, 0, 0, 1, 1)
        spacerItem = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout_2.addItem(spacerItem, 1, 0, 1, 1)
        self.horizontalLayout.addWidget(self.tracksGroupBox)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tracksGroupBox.setTitle(_translate("MainWindow", "Selected tracks"))
        self.track1.setText(_translate("MainWindow", "Track 1"))
        self.colorLabel1.setText(_translate("MainWindow", "o "))
