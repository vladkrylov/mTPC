...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.action_load_training_set = QtWidgets.QAction(MainWindow)
        self.action_load_training_set.setObjectName("action_load_training_set")
        self.action_Hough_transform = QtWidgets.QAction(MainWindow)
        self.action_Hough_transform.setObjectName("action_Hough_transform")
        self.actionFit_selected_track = QtWidgets.QAction(MainWindow)
        self.actionFit_selected_track.setObjectName("actionFit_selected_track")
        self.action_explore_parameters = QtWidgets.QAction(MainWindow)
        self.action_explore_parameters.setObjectName("action_explore_parameters")
        self.actionFit_all_tracks = QtWidgets.QAction(MainWindow)
        self.actionFit_all_tracks.setObjectName("actionFit_all_tracks")
        self.menuSession.addAction(self.action_load_session)
        self.menuSession.addAction(self.action_save_session)
        self.menuSession.addSeparator()
        self.menuSession.addAction(self.action_load_training_set)
        self.menuAnalysis.addAction(self.action_explore_parameters)
        self.menuAnalysis.addAction(self.action_Hough_transform)
        self.menuAnalysis.addSeparator()
        self.menuAnalysis.addAction(self.actionFit_selected_track)
        self.menuAnalysis.addAction(self.actionFit_all_tracks)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menuSession.setTitle(_translate("MainWindow", "Sessio&n"))
        self.menuAnalysis.setTitle(_translate("MainWindow", "Ana&lysis"))
        ...
        self.action_load_session.setText(_translate("MainWindow", "&Load"))
        self.action_load_session.setToolTip(_translate("MainWindow", "Load a session"))
        self.action_save_session.setText(_translate("MainWindow", "&Save"))
        self.action_save_session.setToolTip(_translate("MainWindow", "Save current session"))
        self.action_load_training_set.setText(_translate("MainWindow", "L&oad training set"))
        self.action_Hough_transform.setText(_translate("MainWindow", "&Hough transform"))
        self.actionFit_selected_track.setText(_translate("MainWindow", "&Fit selected track"))
        self.action_explore_parameters.setText(_translate("MainWindow", "Explore parameters"))
        self.actionFit_all_tracks.setText(_translate("MainWindow", "Fit all tracks"))
